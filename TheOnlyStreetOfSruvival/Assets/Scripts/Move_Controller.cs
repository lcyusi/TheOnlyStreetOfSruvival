...
public class Move_Controller : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            //transform.GetComponent<Animator>().SetFloat("speed", "run");//将人物的动画改为移动状态，这里有个问题，就是动画组件的获取也要在update里获取，请读者自行修改吧
            transform.GetComponent<Animator>().SetFloat("speed", 5);
            ...
            //静止状态
            //transform.GetComponent<Animator>().SetFloat("speed", "stand");
